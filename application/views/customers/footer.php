    ...
    $(document).ready(function() {
        $('.delete-customer').click(function() {
            ...
            var v_no = $("#vehicle_no").val();
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>Customers/delete", //34
                    data: ({
                        id: id,
                        v_no:v_no
                    }),
                    ...
                    success: function(data) {
                        ...
                        $("#customer" + id).fadeOut('slow');
                    }
                });
        })
        ;
        $(document).ready(function() {
        $('.active-customer').click(function() {
            var id = $(this).attr("id");
            var v_no = $("#vehicle_no").val();
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>Customers/Active", //181
                    data: ({
                        id: id,
                        v_no:v_no
                    }),
