                ...
                <?php
                  ...
                  foreach ($customers as $customer){
                    ?>
                      ...
                      <tr id="customer<?php echo $customer->vehicle_id;?>">
                        <td class="text-center"><?php echo $i; ?></td>
                        <td><?php echo $customer->vehicle_no; ?></td>
                        <td><?php echo $customer->contact_no; ?></td>
                        <td class="text-center">
                          <a id="<?php echo $customer->vehicle_id;?>" class="btn btn-danger btn-xs delete-customer">
                            <i class="fa fa-trash-o "></i>
                          </a>
                          <a href="<?php echo base_url(); ?>Customers/block/<?php echo $customer->vehicle_id; ?>/<?php echo $customer->vehicle_no; ?>" class="btn btn-warning btn-xs">
                            <i class="fa fa-ban "></i>
                          </a>
                        </td>
                      </tr>
