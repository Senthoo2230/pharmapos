                  ...
                  foreach ($confirmed as $confirm){
                    ?>
                      <tr class="gradeX">
                        ...
                        <td><?php echo $confirm->vehicle_no; ?></td>
                        <td><?php echo $confirm->contact_no; ?></td>
                        <td><?php echo $confirm->service; ?></td>
                        <td id="date_<?php echo $confirm->book_id; ?>"><?php echo date('Y-m-d', strtotime($confirm->book_date)); ?></td>
                        <td id="time_<?php echo $confirm->book_id; ?>"><?php echo date('H:i', strtotime($confirm->book_time)); ?></td>

                        <td class="text-center">
                            <a href="<?php echo base_url(); ?>Booking/done/<?php echo $confirm->book_id; ?>/<?php echo $confirm->name; ?>" class="btn btn-success btn-sm">Done</a>
                            <button class="btn btn-danger btn-sm" onclick="cancel_confirmed(<?php echo $confirm->book_id; ?>)">Cancel</button>
                        </td>
                      </tr>
                    <?php
                    $i++;
